...
class ProfileOverViewComponent extends React.Component {
    ...
    render() {                   
        return (        
                ...
                <ProfileCard>
                    <ProfileLeft>
                        <Image>
                        <ProfileImage alt="profile" src={this.state.mentee.picture ? this.state.mentee.picture.thumbnailUrl : ''} />
                        <SubProfileImage alt="profile" src={this.state.mentee.company ? (this.state.mentee.company.logo ? this.state.mentee.company.logo.thumbnailUrl : '') : ''} />
                        </Image>
                        <Texts>
                        <Name>{this.state.mentee.firstName}</Name>
                        <Title>{this.state.mentee.title} at {this.state.mentee.companyName}</Title>
                    ...
                    <ProfileRight>
                        ...
                        <TextIndex>
                            ...
                            {this.state.mentee ? (this.state.mentee.company ? this.state.mentee.company.nbEmployees : '') : ''}
                        </TextIndex>
                        <Notes>
                            <strong>Notes: </strong>
...
export default connect(mapStateToProps, mapDispatchToProps)(ProfileOverViewComponent);
